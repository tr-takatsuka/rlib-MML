...
|DefinePresetPSG(<br>&emsp;no:[program no],<br>&emsp;name:[name],<br>&emsp;[data]...<br>)|Sequencer specific meta event that defines PSG sound tone in rlib-MML.|DefinePresetPSG(no:5, name:"piano",<br>// AR   HR    DR   SL   RR		noise	tone<br>  0.0, 0.0,  1.0, 0.3, 1.0,		   -1,     1,<br>)<br>// AR,HR,DR,SL,RR : Software envelope parameters<br>// noise : noise freq(0-31) -1=OFF<br>// tone : tone 1=ON/0=OFF|
